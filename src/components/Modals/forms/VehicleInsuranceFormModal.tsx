...
import { vehicleInsuranceApplicationSchema, VehicleInsuranceApplicationT } from "@/types/comingData/vehicleInsurance";
...
interface vehicleInsuranceFormModalProps {
  visible: boolean;
  onClose: () => void;
  onSubmit: (data: Partial<VehicleInsuranceApplicationT>, method: "put" | 'post') => void;
  initialData?: VehicleInsuranceApplicationT | null;
  vehiclesData: { label: string, value: number }[] | undefined

}

const VehicleInsuranceFormModel = ({
  visible,
  onClose,
  onSubmit,
  initialData,
...
export default VehicleInsuranceFormModel
